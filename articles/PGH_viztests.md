...
```
    ...
    ## 
    ## ── R CMD build ─────────────────────────────────────────────────────────────────
    ## * checking for file ‘/tmp/RtmpiduJ77/remotes21ba32f6f79e/kfarleigh-PopGenHelpR-2f92f9d/DESCRIPTION’ ... OK
...
```
    ...
    ## Cached as: /tmp/RtmpiduJ77/elevation/wc2.1_5m//wc2.1_5m_elev.zip
...
```
    ...
    ## Cached as: /tmp/RtmpiduJ77/climate/wc2.1_5m//wc2.1_5m_tavg.zip
...
```
    ...
    ## Cached as: /tmp/RtmpiduJ77/gadm/gadm36_adm0_r5_pk.rds

    ## Cached as: /tmp/RtmpiduJ77/gadm/gadm41_USA_1_pk.rds

    ## Cached as: /tmp/RtmpiduJ77/gadm/gadm41_CAN_1_pk.rds

    ## Cached as: /tmp/RtmpiduJ77/gadm/gadm41_MEX_1_pk.rds
