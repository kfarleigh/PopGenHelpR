...
We also performed additional testing using external data to ensure that PopGenHelpR works with real world data. You can find those tests at https://github.com/kfarleigh/PopGenHelpR_testing.
