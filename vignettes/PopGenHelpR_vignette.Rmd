...
```
## Welcome
Welcome to the PopGenHelpR vignette, please contact the authors if you have any questions about the package.You can also visit our Github for additional examples (https://github.com/kfarleigh/PopGenHelpR) 
```{r setup}
# Load the package
library(PopGenHelpR)
```
