...
- center:
  ...
  Boolean. Whether or not to center the data before principal component
  analysis.

- scale:

  Boolean. Whether or not to scale the data before principal component
  analysis.
...
- write:
  ...
  working directory. There will be two files, one for the individual
  loadings and the other for the percent variance explained by each
  axis.
...
A list containing two elements: the loadings of individuals on each
principal component and the variance explained by each principal
component.
