...
# Load the package
library(PopGenHelpR)
# Install rnaturalearthhires if you need it
...
plot.type = 'all', col = c('#d73027', '#f46d43', '#e0f3f8', '#74add1', '#313695'), countries = c("united states of america", "mexico"), Lat_buffer = 1, Long_buffer = 1)
